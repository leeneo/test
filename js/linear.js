...
let initialise = function () {
	...
	let addTracer = (position, colour) => {
		...
		if (colour) {
			...
			tracer.colour = 'RGBA(' + Math.round(Math.random() * 255) + ',' + 100 + Math.round(Math.random() *
				155) + ',255,0.2)';
		}
...
var cans = document.getElementsByClassName('drawer');
cans[0].setAttribute('style', 'position: fixed;top: 0px;left: 0px;width: 100vw;height: 100vh;z-index:-1;');